...
const contractABI = require("../artifacts/contracts/Depthstream.sol/Depthstream.json").abi;

program
    .name("depthstream-cli")
    .description("CLI tool for Depthstream smart contract")
    .version("1.0.0");
